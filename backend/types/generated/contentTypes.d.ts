...
export interface ApiBusinessUnitBusinessUnit
  ...
  attributes: {
    ...
    folders: Schema.Attribute.Relation<'oneToMany', 'api::folder.folder'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDocumentAccessDocumentAccess
  extends Struct.CollectionTypeSchema {
  collectionName: 'document_accesses';
  info: {
    displayName: 'Document Access';
    pluralName: 'document-accesses';
    singularName: 'document-access';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    access: Schema.Attribute.Enumeration<['view', 'edit', 'none']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-access.document-access'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDocumentShareDocumentShare
  ...
  attributes: {
    access: Schema.Attribute.Enumeration<['consume', 'crud']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    targetBu: Schema.Attribute.Relation<
      'manyToOne',
      'api::business-unit.business-unit'
    >;
    targetType: Schema.Attribute.Enumeration<['bu', 'user']> &
      Schema.Attribute.Required;
    targetUser: Schema.Attribute.Relation<'manyToOne', 'admin::user'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentAccesses: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-access.document-access'
    >;
    documentShares: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-share.document-share'
    >;
...
export interface ApiFolderFolder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    parent: Schema.Attribute.Relation<'manyToOne', 'api::folder.folder'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTemplateTemplate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    folder: Schema.Attribute.Relation<'manyToOne', 'api::folder.folder'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserBuRoleUserBuRole extends Struct.CollectionTypeSchema {
  collectionName: 'user_bu_roles';
  info: {
    displayName: 'User BU Role';
    pluralName: 'user-bu-roles';
    singularName: 'user-bu-role';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['viewer', 'editor', 'admin']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::document-access.document-access': ApiDocumentAccessDocumentAccess;
      ...
      'api::user-bu-role.user-bu-role': ApiUserBuRoleUserBuRole;
