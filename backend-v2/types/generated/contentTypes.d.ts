...
export interface ApiContentCategoryContentCategory
  ...
  info: {
    description: 'Hierarchical folder structure for documentation';
...
export interface ApiContentItemContentItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Main documentation pages (rich text, embedded images, Swagger/OpenAPI)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_version: Schema.Attribute.Relation<
      'manyToOne',
      'api::version.version'
    >;
    ...
    >;
    operations: Schema.Attribute.JSON;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    plantuml_source: Schema.Attribute.Text;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    source_path: Schema.Attribute.String;
    summary: Schema.Attribute.Text;
    swagger: Schema.Attribute.Relation<'manyToOne', 'api::swagger.swagger'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    versions: Schema.Attribute.Relation<'oneToMany', 'api::version.version'>;
...
export interface ApiNavigationItemNavigationItem
  ...
  info: {
    description: 'Sidebar or top navigation menus';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product or API group (e.g. Billing API, SIM Management)';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Flexible search and grouping';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface ApiTenantTenant extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Multi-tenant isolation (partners, internal teams, public portal)';
    displayName: 'Tenant';
    pluralName: 'tenants';
    singularName: 'tenant';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    tenant_key: Schema.Attribute.UID<'name'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiVersionVersion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tracks documentation versions per content item for rollback/history';
  ...
  attributes: {
    ...
    content_item: Schema.Attribute.Relation<
      ...
      'api::content-item.content-item'
    >;
    created_by: Schema.Attribute.Relation<'manyToOne', 'admin::user'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
